...
public class Pinyin {
	...
	public static List<String> multiplePinyin(String str) {
		return MultiplePinyinUtil.INSTANCE.convert(str, PinyinFormat.TONELESS_PINYIN_FORMAT);
	}
	...
	public static List<String> multipleFirstChar(String str) {
		return MultiplePinyinUtil.INSTANCE.convert(str, PinyinFormat.ABBR_PINYIN_FORMAT);
	}
	...
	public static List<String> MutipUnicodePinyin(String str) {
		return MultiplePinyinUtil.INSTANCE.convert(str, PinyinFormat.UNICODE_PINYIN_FORMAT);
	}
	...
	public static List<String> MultipTonePinyin(String str) {
		return MultiplePinyinUtil.INSTANCE.convert(str, PinyinFormat.DEFAULT_PINYIN_FORMAT);
	}
